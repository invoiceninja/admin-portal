...
class TaxRateRepository {
  const TaxRateRepository({this.webClient = const WebClient()});
  ...
  Future<TaxRateEntity> loadItem(
    ...
    final dynamic response = await webClient.get(
      '${credentials.url}/tax_rates/$entityId',
      credentials.token,
    );

    final TaxRateItemResponse taxRateResponse = serializers.deserializeWith(
      TaxRateItemResponse.serializer,
      response,
    )!;
  ...
  Future<BuiltList<TaxRateEntity>> loadList(Credentials credentials) async {
    ...
    final TaxRateListResponse taxRateResponse = serializers.deserializeWith(
      TaxRateListResponse.serializer,
      response,
    )!;
