...
class PaymentRepository {
  const PaymentRepository({this.webClient = const WebClient()});
  ...
  Future<List<PaymentEntity>> bulkAction(
    ...
    final PaymentListResponse paymentResponse = serializers.deserializeWith(
      PaymentListResponse.serializer,
      response,
    )!;
  ...
  Future<PaymentEntity> saveData(
    ...
    final PaymentItemResponse paymentResponse = serializers.deserializeWith(
      PaymentItemResponse.serializer,
      response,
    )!;
  ...
  Future<PaymentEntity> uploadDocument(
    ...
    final dynamic response = await webClient.post(
      '${credentials.url}/payments/${entity.id}/upload',
      credentials.token,
      data: fields,
      multipartFiles: multipartFiles,
    );

    final PaymentItemResponse paymentItemResponse = serializers.deserializeWith(
      PaymentItemResponse.serializer,
      response,
    )!;
