...
class TaskRepository {
  ...
  Future<TaskEntity> saveData(
    ...
    if ([EntityAction.start, EntityAction.resume].contains(action)) {
      url += '&start=true';
  ...
  Future<TaskEntity> uploadDocument(
    ...
    final dynamic response = await webClient.post(
      '${credentials.url}/tasks/${entity.id}/upload',
      credentials.token,
      data: fields,
