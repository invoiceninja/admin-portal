...
class PaymentTermRepository {
  const PaymentTermRepository({this.webClient = const WebClient()});
  ...
  Future<PaymentTermEntity> loadItem(
    ...
    final dynamic response = await webClient.get(
      '${credentials.url}/payment_terms/$entityId',
      credentials.token,
    );
