...
class TransactionRepository {
  const TransactionRepository({this.webClient = const WebClient()});
  ...
  Future<TransactionEntity> loadItem(
    ...
    final dynamic response = await webClient.get(
      '${credentials.url}/bank_transactions/$entityId',
      credentials.token,
    );
  ...
  Future<TransactionEntity> convertToPayment(
    Credentials credentials,
  ...
  Future<TransactionEntity> saveData(
    ...
    if (transaction.isNew) {
      response = await webClient.post(
        credentials.url + '/bank_transactions',
        credentials.token,
