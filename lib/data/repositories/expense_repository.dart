...
class ExpenseRepository {
  const ExpenseRepository({this.webClient = const WebClient()});
  ...
  Future<ExpenseEntity> loadItem(
    ...
    final dynamic response = await webClient.get(
      '${credentials.url}/expenses/$entityId',
      credentials.token,
    );
  ...
  Future<List<ExpenseEntity>> bulkAction(
    ...
    final ExpenseListResponse expenseResponse = serializers.deserializeWith(
      ExpenseListResponse.serializer,
      response,
    )!;
  ...
  Future<ExpenseEntity> saveData(
    ...
    final ExpenseItemResponse expenseResponse = serializers.deserializeWith(
      ExpenseItemResponse.serializer,
      response,
    )!;
  ...
  Future<ExpenseEntity> uploadDocuments(
    ...
    final dynamic response = await webClient.post(
      '${credentials.url}/expenses/${entity.id}/upload',
      credentials.token,
      data: fields,
