...
class VendorRepository {
  const VendorRepository({this.webClient = const WebClient()});
  ...
  Future<VendorEntity> saveData(
    ...
    if (vendor.isNew) {
      response = await webClient.post(
        credentials.url + '/vendors?include=activities',
        credentials.token,
  ...
  Future<VendorEntity> merge({
    ...
    final VendorItemResponse clientResponse = serializers.deserializeWith(
      VendorItemResponse.serializer,
      response,
    )!;
  ...
  Future<VendorEntity> uploadDocument(
    ...
    final dynamic response = await webClient.post(
      '${credentials.url}/vendors/${entity.id}/upload',
      credentials.token,
      data: fields,
