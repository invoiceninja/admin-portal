...
abstract class GatewayTypeEntity extends Object
    with SelectableEntity
    implements Built<GatewayTypeEntity, GatewayTypeEntityBuilder> {
  factory GatewayTypeEntity({String id, String name}) {
    return _$GatewayTypeEntity._(
      id: id ?? BaseEntity.nextId,
      name: name ?? '',
    );
  }
  ...
  int compareTo(
      GatewayTypeEntity gatewayType, String sortField, bool sortAscending) {
    final GatewayTypeEntity gatewayTypeA = sortAscending ? this : gatewayType;
    final GatewayTypeEntity gatewayTypeB = sortAscending ? gatewayType : this;

    return gatewayTypeA.name
        .toLowerCase()
        .compareTo(gatewayTypeB.name.toLowerCase());
  }
  ...
  static Serializer<GatewayTypeEntity> get serializer =>
      _$gatewayTypeEntitySerializer;
}
