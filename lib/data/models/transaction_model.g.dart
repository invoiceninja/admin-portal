...
class _$TransactionItemResponseSerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    TransactionItemResponse object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'data',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'category_type':
          ...
          break;
        case 'base_type':
          result.baseType = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'ninja_category_id':
          ...
          break;
        case 'invoice_ids':
          result.invoiceIds = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'bank_transaction_rule_id':
          result.transactionRuleId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'participant_name':
          result.participantName = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'participant':
          result.participant = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'pendingVendorId':
          result.pendingVendorId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String?;
          break;
...
class _$TransactionStatusEntitySerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    TransactionStatusEntity object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'id',
...
class TransactionListResponseBuilder
  ...
  _$TransactionListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$TransactionListResponse._(data: data.build());
    } catch (_) {
...
class TransactionItemResponseBuilder
  ...
  _$TransactionItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$TransactionItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
