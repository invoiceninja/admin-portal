...
class _$ClientEntitySerializer implements StructuredSerializer<ClientEntity> {
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      ...
      'shipping_address1',
      serializers.serialize(
        object.shippingAddress1,
        specifiedType: const FullType(String),
      ),
      'shipping_address2',
      serializers.serialize(
        object.shippingAddress2,
        specifiedType: const FullType(String),
      ),
      'shipping_city',
      serializers.serialize(
      ...
      serializers.serialize(
        object.contacts,
        specifiedType: const FullType(BuiltList, const [
          const FullType(ClientContactEntity),
        ]),
      ),
      'activities',
      serializers.serialize(
      ...
      serializers.serialize(
        object.ledger,
        specifiedType: const FullType(BuiltList, const [
          const FullType(LedgerEntity),
        ]),
      ),
      'gateway_tokens',
      serializers.serialize(
        object.gatewayTokens,
        specifiedType: const FullType(BuiltList, const [
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'balance':
          ...
          break;
        case 'credit_balance':
          result.creditBalance = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'payment_balance':
          result.paymentBalance = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'paid_to_date':
          ...
          break;
        case 'client_hash':
          result.clientHash = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'shipping_address1':
          result.shippingAddress1 = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'shipping_address2':
          result.shippingAddress2 = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'shipping_city':
          result.shippingCity = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'shipping_state':
          result.shippingState = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'shipping_postal_code':
          result.shippingPostalCode = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'shipping_country_id':
          result.shippingCountryId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'settings':
          ...
          break;
        case 'last_login':
          result.lastLogin = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        ...
        case 'custom_value4':
          ...
          break;
        case 'routing_id':
          result.routingId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'is_tax_exempt':
          result.isTaxExempt = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'has_valid_vat_number':
          result.hasValidVatNumber = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'phone':
          ...
          break;
        case 'contact_key':
          result.contactKey = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'link':
          ...
          break;
        case 'cc_only':
          result.ccOnly = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'is_shipping_location':
          result.isShipping = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
...
class ClientListResponseBuilder
  ...
  _$ClientListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$ClientListResponse._(data: data.build());
    } catch (_) {
...
class ClientItemResponseBuilder
  ...
  _$ClientItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$ClientItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
