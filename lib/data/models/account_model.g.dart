    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'key':
          ...
          break;
        case 'trial_started':
          result.trialStarted = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'default_url':
          result.defaultUrl = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'report_errors':
          result.reportErrors = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'plan':
          result.plan = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'plan_expires':
          result.planExpires = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'latest_version':
          result.latestVersion = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'current_version':
          ...
          break;
        case 'debug_enabled':
          result.debugEnabled = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'is_docker':
          result.isDocker = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'is_migrated':
          result.isMigrated = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'is_hosted':
          result.isHosted = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'is_scheduler_running':
          result.isSchedulerRunning = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'disable_auto_update':
          result.disableAutoUpdate = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'default_company_id':
          result.defaultCompanyId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'hosted_client_count':
          result.hostedClientCount = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'hosted_company_count':
          result.hostedCompanyCount = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'set_react_as_default_ap':
          result.setReactAsDefaultAP = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'account_sms_verified':
          result.accountSmsVerified = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'trial_days_left':
          result.trialDaysLeft = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'has_iap_plan':
          result.hasIapPlan = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'payment_id':
          result.paymentId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'tax_api_enabled':
          result.taxApiEnabled = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'nordigen_enabled':
          result.nordigenEnabled = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'upload_extensions':
          result.uploadExtensions = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
...
class _$AccountEntity extends AccountEntity {
  ...
  @override
  AccountEntityBuilder toBuilder() => AccountEntityBuilder()..replace(this);
  ...
  bool operator ==(Object other) {
    ...
    return other is AccountEntity &&
        ...
        uploadExtensions == other.uploadExtensions;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, uploadExtensions.hashCode);
    _$hash = $jf(_$hash);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'AccountEntity')
          ...
          ..add('uploadExtensions', uploadExtensions))
        .toString();
  }
}
...
class AccountEntityBuilder
  ...
  String? _uploadExtensions;
  String? get uploadExtensions => _$this._uploadExtensions;
  set uploadExtensions(String? uploadExtensions) =>
      _$this._uploadExtensions = uploadExtensions;
  ...
  AccountEntityBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _uploadExtensions = $v.uploadExtensions;
      _$v = null;
    }
    return this;
  }
