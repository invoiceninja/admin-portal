...
Map<String, ColorTheme> colorThemesMap = {
  ...
  'cyborg': ColorTheme(
    ...
    colorSecondary: convertHexStringToColor('#555'),
    colorInfo: convertHexStringToColor('#93c'),
    colorSuccess: convertHexStringToColor('#77b300'),
    colorWarning: convertHexStringToColor('#f80'),
    colorDanger: convertHexStringToColor('#c00'),
    colorLightGray: convertHexStringToColor('#222'),
    colorDarkGray: convertHexStringToColor('#adafae'),
  ),
  'darkly': ColorTheme(
    colorPrimary: convertHexStringToColor('#375a7f'),
    colorSecondary: convertHexStringToColor('#444'),
  ...
  'journal': ColorTheme(
    ...
    colorSecondary: convertHexStringToColor('#aaa'),
    colorInfo: convertHexStringToColor('#369'),
    ...
    colorLightGray: convertHexStringToColor('#f8f9fa'),
    colorDarkGray: convertHexStringToColor('#222'),
  ),
  'litera': ColorTheme(
  ...
  'sketchy': ColorTheme(
    colorPrimary: convertHexStringToColor('#333'),
    colorSecondary: convertHexStringToColor('#555'),
    colorInfo: convertHexStringToColor('#17a2b8'),
  ...
  'spacelab': ColorTheme(
    ...
    colorSecondary: convertHexStringToColor('#999'),
    ...
    colorLightGray: convertHexStringToColor('#eee'),
    colorDarkGray: convertHexStringToColor('#333'),
  ),
  ...
  'yeti': ColorTheme(
    ...
    colorSecondary: convertHexStringToColor('#eee'),
    colorInfo: convertHexStringToColor('#5bc0de'),
