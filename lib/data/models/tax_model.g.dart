...
class _$TaxDataEntitySerializer implements StructuredSerializer<TaxDataEntity> {
  ...
  Iterable<Object?> serialize(
    ...
    TaxDataEntity object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'geoPostalCode',
      serializers.serialize(
        object.geoPostalCode,
      ...
      'countySalesTax',
      serializers.serialize(
        object.countySalesTax,
        specifiedType: const FullType(double),
      ),
      'countyTaxCode',
      serializers.serialize(
        object.countyTaxCode,
        specifiedType: const FullType(String),
      ),
      'districtSalesTax',
      serializers.serialize(
        object.districtSalesTax,
        specifiedType: const FullType(double),
      ),
    ];
  ...
  TaxDataEntity deserialize(
    ...
    final result = TaxDataEntityBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'geoPostalCode':
          result.geoPostalCode = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'geoCity':
          result.geoCity = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'geoCounty':
          result.geoCounty = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'geoState':
          result.geoState = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'taxSales':
          result.taxSales = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'stateSalesTax':
          result.stateSalesTax = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'citySalesTax':
          result.citySalesTax = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'cityTaxCode':
          result.cityTaxCode = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'countySalesTax':
          result.countySalesTax = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'countyTaxCode':
          result.countyTaxCode = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'districtSalesTax':
          result.districtSalesTax = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
...
class _$TaxConfigEntitySerializer
  ...
  TaxConfigEntity deserialize(
    ...
    final result = TaxConfigEntityBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'seller_subregion':
          result.sellerSubregion = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'acts_as_sender':
          result.actsAsSender = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'acts_as_receiver':
          result.actsAsReceiver = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'regions':
          result.regions.replace(
...
class _$TaxConfigRegionEntitySerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    TaxConfigRegionEntity object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'has_sales_above_threshold',
      serializers.serialize(
        object.hasSalesAboveThreshold,
        specifiedType: const FullType(bool),
      ),
      'tax_all_subregions',
  ...
  TaxConfigRegionEntity deserialize(
    ...
    final result = TaxConfigRegionEntityBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'has_sales_above_threshold':
          result.hasSalesAboveThreshold = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'tax_all_subregions':
          result.taxAll = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'tax_threshold':
          result.taxThreshold = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'subregions':
          result.subregions.replace(
            serializers.deserialize(
              value,
              specifiedType: const FullType(BuiltMap, const [
                const FullType(String),
...
class _$TaxConfigSubregionEntitySerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    TaxConfigSubregionEntity object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'apply_tax',
  ...
  TaxConfigSubregionEntity deserialize(
    ...
    final result = TaxConfigSubregionEntityBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'apply_tax':
          result.applyTax = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'tax_rate':
          result.taxRate = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'tax_name':
          result.taxName = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'reduced_tax_rate':
          result.reducedTaxRate = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
...
class _$TaxDataEntity extends TaxDataEntity {
  ...
  factory _$TaxDataEntity([void Function(TaxDataEntityBuilder)? updates]) =>
      (TaxDataEntityBuilder()..update(updates))._build();
  ...
  @override
  TaxDataEntityBuilder toBuilder() => TaxDataEntityBuilder()..replace(this);
  ...
  _$TaxDataEntity _build() {
    final _$result = _$v ??
        _$TaxDataEntity._(
          ...
          countySalesTax: BuiltValueNullFieldError.checkNotNull(
            countySalesTax,
            r'TaxDataEntity',
            'countySalesTax',
          ),
          countyTaxCode: BuiltValueNullFieldError.checkNotNull(
            countyTaxCode,
            r'TaxDataEntity',
            'countyTaxCode',
          ),
          districtSalesTax: BuiltValueNullFieldError.checkNotNull(
            districtSalesTax,
            r'TaxDataEntity',
            'districtSalesTax',
          ),
...
class _$TaxConfigEntity extends TaxConfigEntity {
  ...
  factory _$TaxConfigEntity([void Function(TaxConfigEntityBuilder)? updates]) =>
      (TaxConfigEntityBuilder()..update(updates))._build();
  ...
  @override
  TaxConfigEntityBuilder toBuilder() => TaxConfigEntityBuilder()..replace(this);
...
class TaxConfigEntityBuilder
  ...
  MapBuilder<String, TaxConfigRegionEntity> get regions =>
      _$this._regions ??= MapBuilder<String, TaxConfigRegionEntity>();
...
class _$TaxConfigRegionEntity extends TaxConfigRegionEntity {
  ...
  factory _$TaxConfigRegionEntity([
    void Function(TaxConfigRegionEntityBuilder)? updates,
      ...
      (TaxConfigRegionEntityBuilder()..update(updates))._build();
  ...
  TaxConfigRegionEntityBuilder toBuilder() =>
      TaxConfigRegionEntityBuilder()..replace(this);
...
class TaxConfigRegionEntityBuilder
  ...
  MapBuilder<String, TaxConfigSubregionEntity> get subregions =>
      _$this._subregions ??= MapBuilder<String, TaxConfigSubregionEntity>();
...
class _$TaxConfigSubregionEntity extends TaxConfigSubregionEntity {
  ...
  factory _$TaxConfigSubregionEntity([
    void Function(TaxConfigSubregionEntityBuilder)? updates,
      ...
      (TaxConfigSubregionEntityBuilder()..update(updates))._build();
  ...
  TaxConfigSubregionEntityBuilder toBuilder() =>
      TaxConfigSubregionEntityBuilder()..replace(this);
