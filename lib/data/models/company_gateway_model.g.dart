...
class _$CompanyGatewayListResponseSerializer
  ...
  Iterable<Object?> serialize(
    ...
    CompanyGatewayListResponse object, {
  ...
  CompanyGatewayListResponse deserialize(
    ...
    final result = CompanyGatewayListResponseBuilder();
...
class _$CompanyGatewayItemResponseSerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    CompanyGatewayItemResponse object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'data',
  ...
  CompanyGatewayItemResponse deserialize(
    ...
    final result = CompanyGatewayItemResponseBuilder();
...
class _$CompanyGatewayEntitySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      ...
      serializers.serialize(
        object.acceptedCreditCards,
        specifiedType: const FullType(int),
      ),
      'require_shipping_address',
      serializers.serialize(
        object.requireShippingAddress,
        specifiedType: const FullType(bool),
      ),
      'require_billing_address',
      serializers.serialize(
        object.requireBillingAddress,
        specifiedType: const FullType(bool),
      ),
      'require_client_name',
      serializers.serialize(
        object.requireClientName,
        specifiedType: const FullType(bool),
      ),
      'require_client_phone',
      serializers.serialize(
        object.requireClientPhone,
        specifiedType: const FullType(bool),
      ),
      'require_contact_name',
      serializers.serialize(
        object.requireContactName,
        specifiedType: const FullType(bool),
      ),
      'require_contact_email',
      serializers.serialize(
        object.requireContactEmail,
        specifiedType: const FullType(bool),
      ),
      'require_custom_value1',
      serializers.serialize(
        object.requireCustomValue1,
        specifiedType: const FullType(bool),
      ),
      'require_custom_value2',
      serializers.serialize(
        object.requireCustomValue2,
        specifiedType: const FullType(bool),
      ),
      'require_custom_value3',
      serializers.serialize(
        object.requireCustomValue3,
        specifiedType: const FullType(bool),
      ),
      'require_custom_value4',
      serializers.serialize(
        object.requireCustomValue4,
        specifiedType: const FullType(bool),
      ),
      'require_cvv',
      serializers.serialize(
      ...
      serializers.serialize(
        object.alwaysShowRequiredFields,
        specifiedType: const FullType(bool),
      ),
      'label',
      serializers.serialize(
  ...
  CompanyGatewayEntity deserialize(
    ...
    final result = CompanyGatewayEntityBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'accepted_credit_cards':
          result.acceptedCreditCards = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'require_shipping_address':
          result.requireShippingAddress = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_billing_address':
          result.requireBillingAddress = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_client_name':
          result.requireClientName = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_postal_code':
          result.requirePostalCode = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool?;
          break;
        case 'require_client_phone':
          result.requireClientPhone = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_contact_name':
          result.requireContactName = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_contact_email':
          result.requireContactEmail = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_custom_value1':
          result.requireCustomValue1 = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_custom_value2':
          result.requireCustomValue2 = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_custom_value3':
          result.requireCustomValue3 = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_custom_value4':
          result.requireCustomValue4 = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'require_cvv':
          result.requireCvv = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'update_details':
          result.updateDetails = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'fees_and_limits':
          result.feesAndLimitsMap.replace(
            serializers.deserialize(
              value,
              specifiedType: const FullType(BuiltMap, const [
                const FullType.nullable(String),
        ...
        case 'custom_value4':
          ...
          break;
        case 'config':
          result.config = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'token_billing':
          result.tokenBilling = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'test_mode':
          result.isTestMode = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'always_show_required_fields':
          result.alwaysShowRequiredFields = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
...
class _$FeesAndLimitsSettingsSerializer
  ...
  FeesAndLimitsSettings deserialize(
    ...
    final result = FeesAndLimitsSettingsBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'min_limit':
          result.minLimit = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'max_limit':
          result.maxLimit = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_amount':
          result.feeAmount = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_percent':
          result.feePercent = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_cap':
          result.feeCap = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_tax_rate1':
          result.taxRate1 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_tax_name1':
          result.taxName1 = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'fee_tax_rate2':
          result.taxRate2 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_tax_name2':
          result.taxName2 = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'fee_tax_rate3':
          result.taxRate3 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'fee_tax_name3':
          result.taxName3 = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'adjust_fee_percent':
          result.adjustFeePercent = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
...
class _$CompanyGatewayListResponse extends CompanyGatewayListResponse {
  ...
  factory _$CompanyGatewayListResponse([
    void Function(CompanyGatewayListResponseBuilder)? updates,
      ...
      (CompanyGatewayListResponseBuilder()..update(updates))._build();
  ...
  CompanyGatewayListResponseBuilder toBuilder() =>
      CompanyGatewayListResponseBuilder()..replace(this);
...
class CompanyGatewayListResponseBuilder
  ...
  ListBuilder<CompanyGatewayEntity> get data =>
      _$this._data ??= ListBuilder<CompanyGatewayEntity>();
  ...
  _$CompanyGatewayListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$CompanyGatewayListResponse._(data: data.build());
    } catch (_) {
...
class _$CompanyGatewayItemResponse extends CompanyGatewayItemResponse {
  ...
  factory _$CompanyGatewayItemResponse([
    void Function(CompanyGatewayItemResponseBuilder)? updates,
      ...
      (CompanyGatewayItemResponseBuilder()..update(updates))._build();
  ...
  CompanyGatewayItemResponseBuilder toBuilder() =>
      CompanyGatewayItemResponseBuilder()..replace(this);
...
class CompanyGatewayItemResponseBuilder
  ...
  CompanyGatewayEntityBuilder get data =>
      _$this._data ??= CompanyGatewayEntityBuilder();
  ...
  _$CompanyGatewayItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$CompanyGatewayItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
...
class _$CompanyGatewayEntity extends CompanyGatewayEntity {
  ...
  factory _$CompanyGatewayEntity([
    void Function(CompanyGatewayEntityBuilder)? updates,
      ...
      (CompanyGatewayEntityBuilder()..update(updates))._build();
  ...
  CompanyGatewayEntityBuilder toBuilder() =>
      CompanyGatewayEntityBuilder()..replace(this);
...
class CompanyGatewayEntityBuilder
  ...
  MapBuilder<String?, FeesAndLimitsSettings> get feesAndLimitsMap =>
      _$this._feesAndLimitsMap ??= MapBuilder<String?, FeesAndLimitsSettings>();
    ...
    try {
      _$result = _$v ??
          _$CompanyGatewayEntity._(
            ...
            requireContactEmail: BuiltValueNullFieldError.checkNotNull(
              requireContactEmail,
              r'CompanyGatewayEntity',
              'requireContactEmail',
            ),
            requireCustomValue1: BuiltValueNullFieldError.checkNotNull(
              requireCustomValue1,
              r'CompanyGatewayEntity',
              'requireCustomValue1',
            ),
            requireCustomValue2: BuiltValueNullFieldError.checkNotNull(
              requireCustomValue2,
              r'CompanyGatewayEntity',
              'requireCustomValue2',
            ),
            requireCustomValue3: BuiltValueNullFieldError.checkNotNull(
              requireCustomValue3,
              r'CompanyGatewayEntity',
              'requireCustomValue3',
            ),
            requireCustomValue4: BuiltValueNullFieldError.checkNotNull(
              requireCustomValue4,
              r'CompanyGatewayEntity',
              'requireCustomValue4',
            ),
            requireCvv: BuiltValueNullFieldError.checkNotNull(
              requireCvv,
              r'CompanyGatewayEntity',
              'requireCvv',
            ),
            updateDetails: BuiltValueNullFieldError.checkNotNull(
              updateDetails,
              r'CompanyGatewayEntity',
              'updateDetails',
            ),
            ...
            tokenBilling: BuiltValueNullFieldError.checkNotNull(
              tokenBilling,
              r'CompanyGatewayEntity',
              'tokenBilling',
            ),
            isTestMode: BuiltValueNullFieldError.checkNotNull(
              isTestMode,
              r'CompanyGatewayEntity',
              'isTestMode',
            ),
            alwaysShowRequiredFields: BuiltValueNullFieldError.checkNotNull(
...
class _$FeesAndLimitsSettings extends FeesAndLimitsSettings {
  ...
  factory _$FeesAndLimitsSettings([
    void Function(FeesAndLimitsSettingsBuilder)? updates,
      ...
      (FeesAndLimitsSettingsBuilder()..update(updates))._build();
  ...
  FeesAndLimitsSettingsBuilder toBuilder() =>
      FeesAndLimitsSettingsBuilder()..replace(this);
  ...
  _$FeesAndLimitsSettings _build() {
    final _$result = _$v ??
        _$FeesAndLimitsSettings._(
          ...
          adjustFeePercent: BuiltValueNullFieldError.checkNotNull(
            adjustFeePercent,
            r'FeesAndLimitsSettings',
            'adjustFeePercent',
          ),
