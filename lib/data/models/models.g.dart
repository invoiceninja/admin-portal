...
const EntityAction _$cloneToOther = const EntityAction._('cloneToOther');
...
EntityAction _$valueOf(String name) {
  switch (name) {
    ...
    case 'newRecurringExpense':
      return _$newRecurringExpense;
    case 'newRecurringQuote':
      return _$newRecurringQuote;
    case 'newQuote':
      return _$newQuote;
    case 'newCredit':
      return _$newCredit;
