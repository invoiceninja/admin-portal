...
class _$SubscriptionItemResponseSerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    SubscriptionItemResponse object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'data',
...
class _$SubscriptionEntitySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      ...
      serializers.serialize(
        object.recurringProductIds,
        specifiedType: const FullType(String),
      ),
      'optional_product_ids',
      serializers.serialize(
        object.optionalProductIds,
        specifiedType: const FullType(String),
      ),
      'optional_recurring_product_ids',
      serializers.serialize(
        object.optionalRecurringProductIds,
        specifiedType: const FullType(String),
      ),
      ...
      'allow_cancellation',
      serializers.serialize(
        object.allowCancellation,
        specifiedType: const FullType(bool),
      ),
      'per_seat_enabled',
      serializers.serialize(
        object.perSeatEnabled,
        specifiedType: const FullType(bool),
      ),
      'max_seats_limit',
      serializers.serialize(
        object.maxSeatsLimit,
      ...
      serializers.serialize(
        object.allowQueryOverrides,
        specifiedType: const FullType(bool),
      ),
      'allow_plan_changes',
      serializers.serialize(
        object.allowPlanChanges,
        specifiedType: const FullType(bool),
      ),
      'refund_period',
      serializers.serialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'group_id':
          ...
          break;
        case 'product_ids':
          result.productIds = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'recurring_product_ids':
          result.recurringProductIds = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'optional_product_ids':
          result.optionalProductIds = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'optional_recurring_product_ids':
          result.optionalRecurringProductIds = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'registration_required':
          result.registrationRequired = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'use_inventory_management':
          result.useInventoryManagement = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        ...
        case 'auto_bill':
          ...
          break;
        case 'promo_code':
          result.promoCode = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'promo_discount':
          result.promoDiscount = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        ...
        case 'allow_cancellation':
          result.allowCancellation = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'per_seat_enabled':
          result.perSeatEnabled = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'max_seats_limit':
          result.maxSeatsLimit = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'trial_enabled':
          result.trialEnabled = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'trial_duration':
          result.trialDuration = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'allow_query_overrides':
          result.allowQueryOverrides = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'allow_plan_changes':
          result.allowPlanChanges = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'refund_period':
          result.refundPeriod = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'webhook_configuration':
          result.webhookConfiguration.replace(
            serializers.deserialize(
              value,
              specifiedType: const FullType(WebhookConfigurationEntity),
          ...
          break;
        case 'purchase_page':
          result.purchasePage = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'steps':
          result.steps = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
...
class _$WebhookConfigurationEntitySerializer
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    WebhookConfigurationEntity object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = <Object?>[
      'return_url',
      ...
      'post_purchase_url',
      serializers.serialize(
        object.postPurchaseUrl,
        specifiedType: const FullType(String),
      ),
      'post_purchase_rest_method',
      serializers.serialize(
        object.postPurchaseRestMethod,
        specifiedType: const FullType(String),
      ),
      'post_purchase_headers',
      serializers.serialize(
        object.postPurchaseHeaders,
  ...
  WebhookConfigurationEntity deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'return_url':
          result.returnUrl = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'post_purchase_url':
          result.postPurchaseUrl = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'post_purchase_rest_method':
          result.postPurchaseRestMethod = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'post_purchase_headers':
          result.postPurchaseHeaders.replace(
            serializers.deserialize(
              value,
              specifiedType: const FullType(BuiltMap, const [
                const FullType(String),
        ...
        case 'post_purchase_body':
          result.postPurchaseBody = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
...
class SubscriptionListResponseBuilder
  ...
  _$SubscriptionListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$SubscriptionListResponse._(data: data.build());
    } catch (_) {
...
class SubscriptionItemResponseBuilder
  ...
  _$SubscriptionItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$SubscriptionItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
