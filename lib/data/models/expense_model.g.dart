...
class _$ExpenseEntitySerializer implements StructuredSerializer<ExpenseEntity> {
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      ...
      'should_be_invoiced',
      serializers.serialize(
        object.shouldBeInvoiced,
        specifiedType: const FullType(bool),
      ),
      'invoice_documents',
      serializers.serialize(
        object.invoiceDocuments,
        specifiedType: const FullType(bool),
      ),
      'transaction_id',
      serializers.serialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'should_be_invoiced':
          result.shouldBeInvoiced = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'invoice_documents':
          result.invoiceDocuments = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        ...
        case 'transaction_reference':
          ...
          break;
        case 'bank_id':
          result.bankId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'date':
          ...
          break;
        case 'payment_date':
          result.paymentDate = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'invoice_currency_id':
          result.invoiceCurrencyId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'payment_type_id':
          result.paymentTypeId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'custom_value4':
          ...
          break;
        case 'tax_amount1':
          result.taxAmount1 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'tax_amount2':
          result.taxAmount2 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        case 'tax_amount3':
          result.taxAmount3 = serializers.deserialize(
            value,
            specifiedType: const FullType(double),
          )! as double;
          break;
        ...
        case 'calculate_tax_by_amount':
          result.calculateTaxByAmount = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool?;
          break;
        ...
        case 'recurring_expense_id':
          result.recurringExpenseId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        ...
        case 'remaining_cycles':
          result.remainingCycles = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
...
class ExpenseListResponseBuilder
  ...
  _$ExpenseListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$ExpenseListResponse._(data: data.build());
    } catch (_) {
...
class ExpenseItemResponseBuilder
  ...
  _$ExpenseItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$ExpenseItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
