    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'provider_name':
          ...
          break;
        case 'from_date':
          result.fromDate = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'auto_sync':
          result.autoSync = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'disabled_upstream':
          result.disabledUpstream = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
        case 'integration_type':
          result.integrationType = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'nordigen_institution_id':
          result.nordigenInstitutionId = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
        case 'balance':
          ...
          break;
        case 'currency':
          result.currency = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
...
class _$BankAccountEntity extends BankAccountEntity {
  ...
  @override
  final String nordigenInstitutionId;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is BankAccountEntity &&
        ...
        nordigenInstitutionId == other.nordigenInstitutionId &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, nordigenInstitutionId.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'BankAccountEntity')
          ...
          ..add('nordigenInstitutionId', nordigenInstitutionId)
          ..add('balance', balance)
...
class BankAccountEntityBuilder
  ...
  String? _nordigenInstitutionId;
  String? get nordigenInstitutionId => _$this._nordigenInstitutionId;
  set nordigenInstitutionId(String? nordigenInstitutionId) =>
      _$this._nordigenInstitutionId = nordigenInstitutionId;
  ...
  BankAccountEntityBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _nordigenInstitutionId = $v.nordigenInstitutionId;
      _balance = $v.balance;
