    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'type':
          ...
          break;
        case 'help':
          result.help = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'max_length':
          ...
          break;
        case 'min_occurs':
          result.minOccurs = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'max_occurs':
          result.maxOccurs = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          )! as int;
          break;
        case 'pattern':
          result.pattern = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String?;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'ActualDeliveryDate':
          result.actualDeliveryDate = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String?;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'ID':
          ...
          break;
        case 'IssueDate':
          result.issueDate = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String?;
          break;
