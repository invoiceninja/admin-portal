    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'description':
          ...
          break;
        case 'isBillable':
          result.isBillable = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          )! as bool;
          break;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'project_id':
          ...
          break;
        case 'time_log':
          result.timeLog = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          )! as String;
          break;
...
class TaskListResponseBuilder
  ...
  _$TaskListResponse _build() {
    ...
    try {
      _$result = _$v ?? _$TaskListResponse._(data: data.build());
    } catch (_) {
...
class TaskItemResponseBuilder
  ...
  _$TaskItemResponse _build() {
    ...
    try {
      _$result = _$v ?? _$TaskItemResponse._(data: data.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'data';
