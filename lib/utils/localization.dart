...
class AppLocalization {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'nl': {
      ...
      'custom': 'Aangepast',
      'clone_to_invoice': 'Kopieer naar factuur',
      'clone_to_quote': 'Kopieer naar Offerte',
      ...
      'marked_quote_as_sent': 'Offerte succesvol gemarkeerd als verzonden',
      'expired': 'Verlopen',
    },
    'en_AU': {
      'thank_you_for_using_our_app': 'Thank you for using our app!',
    ...
    'el': {
      ...
      'last30_days': 'Προηγούμενες 30 ημέρες',
