...
PrefState prefReducer(
  ...
  return state.rebuild(
    (b) => b
      ..companyPrefs[selectedCompanyId] = companyPrefReducer(
        state.companyPrefs[selectedCompanyId],
        action,
      )
      ...
      ..statementIncludes.replace(
        statementIncludesReducer(state.statementIncludes, action),
      )
      ..isPreviewVisible = isPreviewVisibleReducer(
        state.isPreviewVisible,
        action,
      )
      ..menuSidebarMode = manuSidebarReducer(state.menuSidebarMode, action)
      ..historySidebarMode = historySidebarReducer(
        state.historySidebarMode,
        action,
      )
      ..hideTaskExtensionBanner = hideTaskExtensionBannerReducer(
        state.hideTaskExtensionBanner,
        action,
      )
      ..hideGatewayWarning = hideGatewayWarningReducer(
        state.hideGatewayWarning,
        action,
      )
      ..hideReviewApp = hideReviewAppReducer(state.hideReviewApp, action)
      ..hideOneYearReviewApp = hideOneYearReviewAppReducer(
        state.hideOneYearReviewApp,
        action,
      )
      ..hideTwoYearReviewApp = hideTwoYearReviewAppReducer(
        state.hideTwoYearReviewApp,
        action,
      )
      ...
      ..enableDarkModeSystem = darkModeSystemReducer(
        state.enableDarkModeSystem,
        action,
      )
      ..enableTooltips = enableTooltipsReducer(state.enableTooltips, action)
      ..enableFlexibleSearch = enableFlexibleSearchReducer(
        state.enableFlexibleSearch,
        action,
      )
      ..enableNativeBrowser = enableNativeBrowserReducer(
        state.enableNativeBrowser,
        action,
      )
      ...
      ..longPressSelectionIsDefault = longPressReducer(
        state.longPressSelectionIsDefault,
        action,
      )
      ..tapSelectedToEdit = tapSelectedToEditReducer(
        state.tapSelectedToEdit,
        action,
      )
      ...
      ..darkCustomColors.replace(
        darkCustomColorsReducer(state.darkCustomColors, action),
      )
      ..useSidebarEditor.replace(
        sidebarEditorReducer(state.useSidebarEditor, action),
      )
      ..useSidebarViewer.replace(
        sidebarViewerReducer(state.useSidebarViewer, action),
      )
      ...
      ..enableTouchEvents = enableTouchEventsReducer(
      ...
      ..showPdfPreviewSideBySide = showPdfPreviewSideBySideReducer(
        state.showPdfPreviewSideBySide,
        action,
      ),
  );
}
...
BuiltMap<EntityType, PrefStateSortField> _resortFields(
  ...
  final directon = sortField.rebuild(
    (b) => b
...
Reducer<BuiltMap<EntityType, PrefStateSortField>> sortFieldsReducer =
  ...
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortProducts>(
    (value, action) => _resortFields(value, EntityType.product, action.field),
  ),
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortInvoices>(
    (value, action) => _resortFields(value, EntityType.invoice, action.field),
  ),
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortPayments>(
    (value, action) => _resortFields(value, EntityType.payment, action.field),
  ),
  ...
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortProjects>(
    (value, action) => _resortFields(value, EntityType.project, action.field),
  ),
  ...
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortExpenses>(
    (value, action) => _resortFields(value, EntityType.expense, action.field),
  ),
  ...
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortTaxRates>(
    (value, action) => _resortFields(value, EntityType.taxRate, action.field),
  ),
  ...
  TypedReducer<BuiltMap<EntityType, PrefStateSortField>, SortWebhooks>(
    (value, action) => _resortFields(value, EntityType.webhook, action.field),
  ),
...
Reducer<BuiltList<HistoryRecord>> historyReducer = combineReducers([
  ...
  TypedReducer<BuiltList<HistoryRecord>, PopLastHistory>((historyList, action) {
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewDashboard>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.dashboard),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewReports>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.reports),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewSettings>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewClient>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditClient>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.client.id, entityType: EntityType.client),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewProduct>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditProduct>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.product.id, entityType: EntityType.product),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewInvoice>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditInvoice>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.invoice!.id, entityType: EntityType.invoice),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewPayment>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditPayment>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.payment.id, entityType: EntityType.payment),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewQuote>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.quoteId, entityType: EntityType.quote),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewQuoteList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.quote, page: action.page),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditQuote>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.quote!.id, entityType: EntityType.quote),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewTask>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.taskId, entityType: EntityType.task),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewTaskList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.task, page: action.page),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditTask>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.task!.id, entityType: EntityType.task),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewProject>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditProject>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.project.id, entityType: EntityType.project),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewVendor>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditVendor>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.vendor.id, entityType: EntityType.vendor),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewExpense>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditExpense>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.expense.id, entityType: EntityType.expense),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewCompanyGatewayList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.companyGateway),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewSchedule>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.scheduleId, entityType: EntityType.schedule),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewScheduleList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.schedule),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditSchedule>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.schedule.id, entityType: EntityType.schedule),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewTransactionRuleList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.transactionRule),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewTransactionList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.transaction, page: action.page),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewBankAccountList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.bankAccount),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewPurchaseOrderList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.purchaseOrder, page: action.page),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewRecurringExpenseList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.recurringExpense, page: action.page),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewSubscriptionList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.paymentLink),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewTaskStatus>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.taskStatusId, entityType: EntityType.taskStatus),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewTaskStatusList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.taskStatus),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewExpenseCategoryList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.expenseCategory),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewRecurringInvoiceList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.recurringInvoice, page: action.page),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewWebhook>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewWebhookList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.webhook),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditWebhook>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.webhook.id, entityType: EntityType.webhook),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewToken>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.tokenId, entityType: EntityType.token),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewTokenList>(
    (historyList, action) =>
        _addToHistory(historyList, HistoryRecord(entityType: EntityType.token)),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditToken>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, ViewPaymentTermList>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(entityType: EntityType.paymentTerm),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditPaymentTerm>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(
        id: action.paymentTerm.id,
        entityType: EntityType.paymentTerm,
      ),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, EditDesign>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.design.id, entityType: EntityType.design),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewCredit>(
    (historyList, action) => _addToHistory(
      historyList,
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditCredit>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.credit!.id, entityType: EntityType.credit),
    ),
  ),
  TypedReducer<BuiltList<HistoryRecord>, ViewDocument>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.documentId, entityType: EntityType.document),
    ),
  ),
  ...
  TypedReducer<BuiltList<HistoryRecord>, EditDocument>(
    (historyList, action) => _addToHistory(
      historyList,
      HistoryRecord(id: action.document!.id, entityType: EntityType.document),
    ),
  ),
