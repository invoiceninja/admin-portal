...
class _$BankAccountUIStateSerializer
  ...
  @override
  Iterable<Object> serialize(Serializers serializers, BankAccountUIState object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'listUIState',
...
class _$BankAccountState extends BankAccountState {
  ...
  factory _$BankAccountState(
      ...
      (new BankAccountStateBuilder()..update(updates)).build();

  _$BankAccountState._({this.map, this.list}) : super._() {
    BuiltValueNullFieldError.checkNotNull(map, 'BankAccountState', 'map');
    BuiltValueNullFieldError.checkNotNull(list, 'BankAccountState', 'list');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BankAccountState')
          ..add('map', map)
          ..add('list', list))
        .toString();
  }
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'BankAccountState', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$BankAccountUIState extends BankAccountUIState {
  ...
  factory _$BankAccountUIState(
      ...
      (new BankAccountUIStateBuilder()..update(updates)).build();
  ...
  _$BankAccountUIState._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        listUIState, 'BankAccountUIState', 'listUIState');
    BuiltValueNullFieldError.checkNotNull(
        tabIndex, 'BankAccountUIState', 'tabIndex');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BankAccountUIState')
          ..add('editing', editing)
  ...
  _$BankAccountUIState build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'BankAccountUIState', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
