...
class _$TransactionUIStateSerializer
  ...
  @override
  Iterable<Object> serialize(Serializers serializers, TransactionUIState object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'listUIState',
...
class _$TransactionState extends TransactionState {
  ...
  _$TransactionState._({this.map, this.list}) : super._() {
    BuiltValueNullFieldError.checkNotNull(map, 'TransactionState', 'map');
    BuiltValueNullFieldError.checkNotNull(list, 'TransactionState', 'list');
  }
...
class _$TransactionUIState extends TransactionUIState {
  ...
  factory _$TransactionUIState(
      ...
      (new TransactionUIStateBuilder()..update(updates)).build();
  ...
  _$TransactionUIState._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        listUIState, 'TransactionUIState', 'listUIState');
    BuiltValueNullFieldError.checkNotNull(
        tabIndex, 'TransactionUIState', 'tabIndex');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('TransactionUIState')
          ..add('editing', editing)
  ...
  _$TransactionUIState build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'TransactionUIState', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
