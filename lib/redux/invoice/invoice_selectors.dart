...
var memoizedInvoiceList = memo3((
    BuiltMap<int, InvoiceEntity> invoiceMap,
    BuiltList<int> invoiceList,
    ListUIState invoiceListState) => visibleInvoicesSelector(invoiceMap, invoiceList, invoiceListState)
);
...
List<int> visibleInvoicesSelector(
  ...
  list.sort((invoiceAId, invoiceBId) {
    ...
    return invoiceA.compareTo(invoiceB, invoiceListState.sortField, invoiceListState.sortAscending);
  });
