...
UserState _connectOAuthUser(
  UserState userState,
  ConnectOAuthUserSuccess action,
) {
  return userState.rebuild((b) => b..map[action.user.id] = action.user);
}
...
UserState _disconnectOAuthUser(
  UserState userState,
  DisconnectOAuthUserSuccess action,
) {
  return userState.rebuild((b) => b..map[action.user.id] = action.user);
}
