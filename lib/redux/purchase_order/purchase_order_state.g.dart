...
class PurchaseOrderStateBuilder
  ...
  _$PurchaseOrderState _build() {
    ...
    try {
      _$result =
          _$v ?? _$PurchaseOrderState._(map: map.build(), list: list.build());
    } catch (_) {
