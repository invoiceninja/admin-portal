...
class InvoiceItemListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String? cost = formatNumber(
      invoiceItem!.cost,
      context,
    ...
    if (invoiceItem!.taxRate1 != 0) {
      final taxRate1 = formatNumber(
        invoiceItem!.taxRate1,
        context,
        formatNumberType: FormatNumberType.percent,
      );
    ...
    if (invoiceItem!.taxRate2 != 0) {
      final taxRate2 = formatNumber(
        invoiceItem!.taxRate2,
        context,
        formatNumberType: FormatNumberType.percent,
      );
    ...
    if (invoiceItem!.taxRate3 != 0) {
      final taxRate3 = formatNumber(
        invoiceItem!.taxRate3,
        context,
        formatNumberType: FormatNumberType.percent,
      );
